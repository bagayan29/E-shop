                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="display: flex; align-items: center;">
                                <a href="{{ route('post.edit', $post->id) }}" class="btn btn-sm float-left mr-1"
                                    style="height:30px;width:30px;border-radius:50%" data-toggle="tooltip" title="Edit"
                                    data-placement="bottom"><i class="fas fa-edit" style="color: blue;"></i></a>
                                <form method="POST" action="{{ route('post.destroy', $post->id) }}">
                                    @csrf
                                    @method('delete')
                                    <button class="btn btn-sm dltBtn" data-id="{{ $post->id }}"
                                        style="height:30px;width:30px;border-radius:50%; margin-left: 5px;"
