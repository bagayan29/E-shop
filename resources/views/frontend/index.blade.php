    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item {{(($key==0)? 'active' : '')}}">
            ...
            <div class="carousel-caption d-none d-md-block text-left">
                <center><h1 class="wow fadeInDown">{{$banner->title}}</h1></center>
                <p>{!! html_entity_decode($banner->description) !!}</p>
                <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{route('product-grids')}}" role="button" style="border-radius: 15px;">Shop Now<i
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-service">
                    <i class='fa fa-rocket' style='color: red'></i>
                    <h4>Fash Delivery</h4>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <!-- Start Single Service -->
                <div class="single-service">
                    <i class='fa fa-handshake-o' style='color: red'></i>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="nav-main">
                        ...
                        <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                            ...
                            @if($categories)
                            <li class="nav-item">
                                <button class="btn all-categories-btn" data-filter="*">
                                    All Categories
                                </button>
                            </li>
                            <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="shop-section-title" style="text-align: center;">
                    <h2 style="display: inline-block;">Hot Item</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="owl-carousel popular-slider">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-content">
                          <center>  <h3><a href="{{route('product-detail',$product->slug)}}">{{$product->title}}</a></h3> </center>
                            <div class="product-price">
                                <!-- <span class="old">${{number_format($product->price,2)}}</span> -->
                                @php
                                $after_discount=($product->price-($product->price*$product->discount)/100)
                                @endphp
                               <center> <span>₱{{number_format($after_discount,2)}}</span> </center>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Product -->
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="row">
                    <div class="col-12">
                        <div class="shop-section-title" style="text-align: center;">
                            <h2 style="display: inline-block;">Latest Products</h2>
                        </div>
                    </div>
                </div>
                <section class="shop-home-list section">
                    ...
                    <div class="container">
                        <div class="row">
                            @php
                            $product_lists = DB::table('products')->where('status', 'active')->orderBy('id',
                            'DESC')->limit(8)->get();
                            @endphp
                            @foreach($product_lists as $product)
                                ...
                                <div class="single-list">
                                    <div class="row">
                                        ...
                                        <div class="col-12 no-padding">
                                            <div class="content">
                                            <center> <h4 class="title"><a href="#">{{$product->title}}</a></h4> </center>
                                               <center> <p class="price with-discount">₱{{number_format($product->discount,2)}}</p> </center>
                                            </div>
                                        </div>
                                    </div>
                                </div>
