								...
								@if(Helper::getAllProductFromCart())
									...
									<track>
										...
										<td class="float-right">
											<button class="btn float-right" type="submit" style="border-radius: 20px;">Update</button>
										</td>
									</track>
								@else
										<tr>
...
-->
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									...
									<div class="button5">
										<a href="{{route('checkout')}}" class="btn" style="border-radius: 20px;">Checkout</a>
										<a href="{{route('product-grids')}}" class="btn" style="border-radius: 20px;">Continue shopping</a>
									</div>
								</div>
							</div>
						</div>
